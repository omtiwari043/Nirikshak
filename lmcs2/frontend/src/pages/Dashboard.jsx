...
const PIE_COLORS = ["#138B34", "#F5901A", "#C53B38"];
  ...
  return (
    <Layout>
      <div className="mb-7 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
        <div>
          <p className="page-kicker">NIRIKSHAK overview</p>
          <h2 className="page-title">Inspection dashboard</h2>
          <p className="page-subtitle">Monitor screening activity, report outcomes, and recurring issues.</p>
        </div>
        ...
        <div className="card">
          ...
          <ResponsiveContainer width="100%" height={260}>
            <BarChart data={summary.scans_by_day}>
              ...
              <Tooltip />
              <Bar dataKey="count" fill="#0B3264" radius={[6, 6, 0, 0]} />
            </BarChart>
          </ResponsiveContainer>
        </div>
        <div className="card">
